                      ...
                      try {
                        const res = await fetch('/api/user/profile', {
                          ...
                          body: JSON.stringify({
                            ...
                            profileImage: form.getValues('profileImage') || profileUser.profileImage,
                            work: formData.get('work'),
                            education: formData.get('education'),
                            currentCity: formData.get('currentCity'),
                            hometown: formData.get('hometown'),
                            coverImage: form.getValues('coverImage') || profileUser.coverImage
                          })
                        });
                        ...
                        try {
                          const res = await fetch('/api/user/profile', {
                            ...
                            body: JSON.stringify({
                              ...
                              currentCity: formData.get('currentCity'),
                              hometown: formData.get('hometown'),
                              profileImage: form.getValues('profileImage') || profileUser.profileImage, // Include profile image
                              coverImage: form.getValues('coverImage') || profileUser.coverImage // Include cover image
                            })
                          });
                          if (!res.ok) throw new Error('Failed to update profile');
                          await queryClient.invalidateQueries({ queryKey: [`/api/users/${userId}`] });
